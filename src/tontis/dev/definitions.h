...
// Game configuration
	...
	#define GM_POTIPOTI						0
	#define GM_RENDEZVOUS 					1
	#define GM_NAPIA						2
	#define GM_ALIEN						3
...
// Music
	...
	#define MUSIC_INGAME_POTIPOTI			1
	#define MUSIC_INGAME_NAPIA				4
...
// 
	...
	#define CHR_ROM_MAIN					0x06
	#define CHR_ROM_ALT						0x0A
