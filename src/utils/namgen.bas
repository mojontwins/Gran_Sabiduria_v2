' namgen 0.1 - Converts a .png into a nametable with attributes
...
Sub usage 
	Puts "usage:"
	Puts ""
	Puts "$ namgen.exe in=screen.png out=file.nam pals=pals.png chr=tileset.chr"
	Puts ""
	...
	Puts "chr            The charset. Note that this program will only work with the"
	Puts "               first 256 patterns (4096 bytes) defined!"
End Sub
