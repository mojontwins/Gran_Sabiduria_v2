...
// Game definitions
	...
	#define MAP_W							10		// Size of the BIGGEST map
	#define MAP_H							6
...
// Enems stuff
	...
	#define UPSIDE_DOWN_STOPPER_BITMASK		0xfd	// to decide which parts of the bg will stop the fall
...
// Espectros
	...
	#define ESPECTRO_A 						1
	// CUSTOM {
	// This is a variable in this game.
...
// Player
	...
	#define PLAYER_AX						4
	#define PLAYER_RX						6	
	#define PLAYER_VX_MIN 					16		// (PLAYER_AX << 2)
...
// Expand upon this when needed
	...
	#define SPRITE_EXPLOSION 				ssit_02
	#endif
...
// Animation cells
	...
	#define CELL_SANTOS						0
	#define CELL_MARIA						20

	#define CELL_FACING_RIGHT 				0
	#define CELL_FACING_LEFT				10
	#define CELL_IDLE						0
	#define CELL_WALK_BASE 					2
	#define CELL_DESCENDING					9
	#define CELL_ASCENDING					8
	#define CELL_FIRING						1

	#define CELL_YUN_FACING_RIGHT 			0
	#define CELL_YUN_FACING_LEFT			7
	#define CELL_YUN_IDLE					0
	#define CELL_YUN_WALK_BASE 				1
	#define CELL_YUN_ASCENDING				5
	#define CELL_YUN_DESCENDING				6
